...
{
  \begin{itemize}
  \item 参与 PPT 项目的日常开发与维护
  \item
    参与 Electron 桌面端的开发，主要负责系统设置、快捷键、\\
    macOS 与 Windows 安装文件的打包签名认证，并配置自动化构建流程
  \end{itemize}
}
...
\cvline{工具}{Git / Gulp / Webpack / Jest}
...
\cvline{学习}{WebAssembly /  PWA / Processing / Qt}
